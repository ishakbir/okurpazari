/**
 * Admin Layout Component — Sidebar navigation for admin pages
 */
'use client';
...
const menuItems = [
  ...
  { href: '/admin/bekleyen', label: 'Bekleyen İlanlar', icon: Clock },
  { href: '/admin/kullanicilar', label: 'Kullanıcılar', icon: Users },
  { href: '/admin/kategoriler', label: 'Kategoriler', icon: Tags },
  { href: '/admin/tema', label: 'Tema Ayarları', icon: Palette },
];
