...
export function ListingQA({ listingId, sellerId }: ListingQAProps) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-6">
      <h2 className="text-xl font-bold text-gray-900 mb-6">💬 Sorular ve Cevaplar</h2>
            ...
            <div className="flex-1">
              ...
              <div className="flex justify-between items-center mt-2">
                <p className="text-xs text-gray-500">
                  🔒 Sorunuz başlangıçta sadece siz ve satıcı görebilir. Satıcı yanıtlarken herkese açık yapabilir.
                </p>
                <Button
                  type="submit"
                  size="sm"
      ...
      {!isAuthenticated && (
        <div className="mb-6 p-4 bg-gray-50 rounded-lg text-center">
          <p className="text-gray-600">
            Soru sormak için <a href="/giris" className="text-blue-600 hover:underline">giriş yapın</a>
          </p>
        </div>
      )}
              ...
              {question.replies && question.replies.length > 0 && (
                <div className="ml-13 mt-4 space-y-3">
                  {question.replies.map((reply) => (
                    <div key={reply.id} className="flex gap-3 bg-blue-50 rounded-lg p-3">
                      <div className="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center text-white text-sm font-medium flex-shrink-0">
                        S
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="font-medium text-blue-800">Satıcı</span>
